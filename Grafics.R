...
setwd("C:\Users\Jacivania Nunes\Desktop\PowerBI\Cap12\1-Intro-LinguagemR")
getwd()
...
ggplot(mtcars, aes(x = as.factor(cyl), fill = as.factor(cyl) )) +  
  geom_bar( ) +
  scale_fill_manual(values = c("pink", "green", "grey"))
...
# Plot
plot(carros, type = "o", col = "magenta", ylim = c(0,12))
...
# Cor uniforme
ggplot(dados, aes(x=value)) + 
  geom_histogram(binwidth = 0.2, color="grey", fill=rgb(0.2,0.7,0.1,0.4) ) 
